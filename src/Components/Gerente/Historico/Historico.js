            ...
            <div class="container_white">
                ...
                <div className='listaDeReunioes'>
                    <table className="table table-striped table-hover">
                        ...
                        <tbody>
                        {feedbacks.filter(feedback => feedback.feedback_manager_id == idGerentes).filter(filterFeedbacks => filterFeedbacks.feedback_manage.toLowerCase().includes(seach.toLowerCase())).map(feedback => {
                        return (
