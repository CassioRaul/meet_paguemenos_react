    ...
    <>
      <div className="container_white">
        <Box onSubmit={handleAddSubmit} component="form" noValidate autoComplete="off">
          ...
          {/* Campos do formulário para exibir informações do agendamento */}
          ...
          {/* Campos ocultos para manter informações do agendamento */}
          ...
          <br></br>
          {/* Botões de salvar e fechar o formulário */}
