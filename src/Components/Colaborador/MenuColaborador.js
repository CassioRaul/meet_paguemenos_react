  ...
  return (
    <div className="gerente__responsivo MenuColacorador">
      ...
      <div className="accordion accordion-flush " id="accordionFlushExample">
        <Link to="/AColaborador" className="MenuColaborador__Link " >
          <button className="accordion-button collapsed MenuColaborador_Button btn_home">
            <i className="bi bi-journal-plus"></i>
            <p>Agendar</p>
          </button>
        </Link>
        <Link to="/PColaborador" className="MenuColaborador__Link" >
          <button className="accordion-button collapsed MenuColaborador_Button btn_home">
            <i className="bi bi-clipboard2-data"></i>
            <p>Pdi</p>
          </button>
        </Link>
        <Link to="/HColaborador" className="MenuColaborador__Link">
          <button className="accordion-button collapsed MenuColaborador_Button btn_home">
